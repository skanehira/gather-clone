        ...
        <Modal open={modal === 'Skin'} closeOnOutsideClick>
            <div className='w-96 h-96 flex flex-col items-center justify-between pt-8'>
                ...
                <div className='flex flex-row items-center justify-center gap-4 mb-12'>
                    <button className='hover:bg-light-secondary aspect-square grid place-items-center rounded-lg p-1 outline-none' onClick={decrement}>
                        <ArrowFatLeft className='h-12 w-12'/>
                    </button>
                    <BasicLoadingButton onClick={handleSwitchSkinsClick} loading={loading}>
                        Switch
                    </BasicLoadingButton>
                    <button className='hover:bg-light-secondary aspect-square grid place-items-center rounded-lg p-1 outline-none' onClick={increment}>
