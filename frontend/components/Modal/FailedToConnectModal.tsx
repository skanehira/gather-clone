    ...
    return (
        <Modal open={errorModal === 'Failed To Connect'}>
            <div className='flex flex-col items-center gap-2 p-4 bg-secondary'>
                ...
                <button className='bg-secondary border-2 border-white hover:bg-light-secondary text-white px-2 py-1 rounded-md outline-none' onClick={onRetry}>Retry</button>
            </div>
        </Modal>
    )
}
